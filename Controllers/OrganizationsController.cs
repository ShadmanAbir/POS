...
namespace UtopiaCatering.Controllers
{
    public class OrganizationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrganizationID,OrganizationName,IsDeleted,CreatedDate,CreatedBy")] Organization organization)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrganizationID,OrganizationName,IsDeleted,CreatedDate,CreatedBy")] Organization organization)
        {

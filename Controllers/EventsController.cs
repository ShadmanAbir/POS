...
namespace UtopiaCatering.Controllers
{
    public class EventsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EventID,EventName,OrganizationID,IsDeleted,CreatedDate,CreatedBy")] Events events)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EventID,EventName,OrganizationID,IsDeleted,CreatedDate,CreatedBy")] Events events)
        {
